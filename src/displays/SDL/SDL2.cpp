...
extern "C" {
    ...
    std::shared_ptr<SDL_Window> SDL2::SDL2_CreateWindow(const char *title,
    ...
    std::shared_ptr<SDL_Renderer> SDL2::SDL2_CreateRenderer(SDL_Window *window,
    ...
    std::shared_ptr<SDL_Texture> SDL2::IMG2_LoadTexture(SDL_Renderer *renderer,
        const char *file) {
    ...
    void SDL2::SDL2_QueryTexture(SDL_Texture *texture, Uint32 *format,
        int *access, int *w, int *h) {
        SDL_QueryTexture(texture, format, access, w, h);
    }

    void SDL2::SDL2_RenderCopy(SDL_Renderer *renderer, SDL_Texture *texture,
    ...
    void SDL2::SDL2_RenderFillRect(SDL_Renderer *renderer,
        const SDL_Rect *rect) {
        SDL_RenderFillRect(renderer, rect);
    }

    void SDL2::SDL2_SetRenderDrawColor(SDL_Renderer *renderer, Uint8 r,
        Uint8 g, Uint8 b, Uint8 a) {
        SDL_SetRenderDrawColor(renderer, r, g, b, a);
    }

    std::shared_ptr<TTF_Font> SDL2::TTF2_OpenFont(
    ...
    std::shared_ptr<SDL_Surface> SDL2::TTF2_RenderText_Blended(TTF_Font *font,
    ...
    std::shared_ptr<SDL_Texture> SDL2::SDL2_CreateTextureFromSurface(
    ...
    int SDL2::Mix2_OpenAudio(int frequency, Uint16 format, int channels,
        int chunksize) {
